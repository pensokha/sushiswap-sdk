...
export const FACTORY_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_TESTNET]: '0xF33Ad974790B1821d0437286B7A1A9c5867dc0eA',
  [ChainId.ARBITRUM]: '',
...
export const ROUTER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.BSC_TESTNET]: '0x88667224d922e643b0033878c69Cd97cBA6068ce',
  [ChainId.ARBITRUM]: '',
...
export const SUSHI_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '',
  [ChainId.BSC_TESTNET]: '0x4F7095FA0498E3D4dB99253F8Ab4b58e03d513b2',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const MASTERCHEF_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '',
  [ChainId.BSC_TESTNET]: '0x9b1616ff6C2eAa73112a237f5862c4D6Cf955B03',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const BAR_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '',
  [ChainId.BSC_TESTNET]: '0x8b266161122Bdf2867BE4f4B37B44E72586E4a61',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
...
export const MAKER_ADDRESS: { [chainId in ChainId]: string } = {
  ...
  [ChainId.XDAI]: '',
  [ChainId.BSC]: '',
  [ChainId.BSC_TESTNET]: '0x494196649ec4ad6111cfeFE486dE7DD2Bf22fb69',
  [ChainId.ARBITRUM]: '',
  [ChainId.MOONBASE]: '',
  [ChainId.AVALANCHE]: '',
  [ChainId.FUJI]: '',
